...
namespace GUI {
    ...
    public partial class SchoolDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(string FullName, int Age, string Major) {
...
namespace GUI.SchoolDBDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Students] WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([FullName], [Age], [Major]) VALUES (@FullName, @Age" +
                ", @Major);\r\nSELECT StudentId, FullName, Age, Major FROM Students WHERE (StudentI" +
                "d = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [FullName] = @FullName, [Age] = @Age, [Major] = @Major WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)));
SELECT StudentId, FullName, Age, Major FROM Students WHERE (StudentId = @StudentId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GUI.Properties.Settings.Default.SchoolDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, FullName, Age, Major FROM dbo.Students";
        ...
        public virtual int Delete(int Original_StudentId, string Original_FullName, global::System.Nullable<int> Original_Age, string Original_Major) {
        ...
        public virtual int Insert(string FullName, global::System.Nullable<int> Age, string Major) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, global::System.Nullable<int> Age, string Major, int Original_StudentId, string Original_FullName, global::System.Nullable<int> Original_Age, string Original_Major, int StudentId) {
            if ((FullName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, global::System.Nullable<int> Age, string Major, int Original_StudentId, string Original_FullName, global::System.Nullable<int> Original_Age, string Original_Major) {
            return this.Update(FullName, Age, Major, Original_StudentId, Original_FullName, Original_Age, Original_Major, Original_StudentId);
        }
    }
